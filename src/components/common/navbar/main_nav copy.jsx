        ...
        <>
            <div className='logo-home w-100'>
                <Row className='w-100 d-flex align-items-center justify-content-between'>
                    <Col md={3} className='MyLogo d-flex align-items-center justify-content-start gap-2'>
                        <img className="" src={MyLogo} alt="Logo" />
                        <h5 className='m-0'>ShopStore</h5>
                    </Col>
                    <Col md={6} className='search-product d-flex align-items-center justify-content-start '>
                        <Form.Control
                            ref={searchRef}
                            type="search"
                    ...
                    <Col md={3} className='p-3 d-flex align-items-center justify-content-start gap-4'>
